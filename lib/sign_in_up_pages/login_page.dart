...
class _LoginPageState extends State<LoginPage> {
  ...
  {
    final result = await http.post(Uri.parse("https://hamirflutter.000webhostapp.com/Api/gmaillogin.php"),
        body: {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('ECORP',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 50,color: Colors.black)),
